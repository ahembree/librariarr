...
1. **Prepare the database**
   ...
   The user needs full privileges on the database (`CREATE`, `ALTER`, `DROP`, `INSERT`, `UPDATE`, `DELETE`). PostgreSQL 14 or later is required (17+ recommended). No extensions are needed.
