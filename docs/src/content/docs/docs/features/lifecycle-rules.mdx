...
Seerr fields are only available on **movie and series** rule sets. Seerr doesn't manage music requests, so music rule sets reject Seerr criteria at save time.
:::
