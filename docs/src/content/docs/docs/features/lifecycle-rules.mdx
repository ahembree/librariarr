...
**Is Watchlisted** is different: a Plex watchlist belongs to *your* Plex account, and Librariarr reads it during a full sync — so watchlist changes appear on the next full sync rather than instantly.
:::
