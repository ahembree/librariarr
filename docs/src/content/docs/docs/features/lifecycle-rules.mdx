...
| **Tag** | Add a custom tag in *arr | Sonarr/Radarr/Lidarr |
...
2. Choose the action type (delete, unmonitor, tag)
3. Set action-specific options (e.g., tag name, delete files toggle)
4. Set priority — actions execute top-to-bottom
...
- File size rules accept input in GB but are stored and compared in bytes
