...
Both views use smooth scrolling, so libraries of any size load and render without pagination. The toolbar — search, sort, view controls, and filters — stays pinned to the top of the page while you scroll.
