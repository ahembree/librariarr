...
![The global search palette with results grouped into movies, series, artists, and albums](/screenshots/search.jpg)
...
![Movie library in card view with poster artwork, quality color strips, and alphabet navigation](/screenshots/library.jpg)
