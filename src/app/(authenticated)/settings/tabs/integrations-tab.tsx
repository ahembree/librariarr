  ...
  return (
    <section>
      ...
      <ConfirmRemoveInstanceDialog
        ...
        consequence={
          <>
            This removes the Tracearr connection from Librariarr — any media server pulling its
            watch history from it reverts to the server&apos;s own history on the next sync. Nothing
            is changed in Tracearr itself.
          </>
        }
        onOpenChange={(open) => { if (!open) setConfirmDelete(null); }}
        onConfirm={() => {
