...
export const CONDITION_FIELDS: ConditionField[] = [
  ...
  { value: "arrOriginalLanguage", label: "Original Language", type: "text", section: "arrMedia", enumerable: true, requiresArr: true },
  { value: "arrRuntime", label: "Runtime (min)", type: "number", section: "arrMedia", requiresArr: true },
  ...
  { value: "arrReleaseDate", label: "Release Date", type: "date", section: "arrMedia", requiresArr: true },
  { value: "arrInCinemasDate", label: "In Cinemas Date", type: "date", section: "arrMedia", requiresArr: true },
  { value: "arrFirstAired", label: "First Aired", type: "date", section: "arrMedia", requiresArr: true },
  { value: "arrDateAdded", label: "Date Added", type: "date", section: "arrMedia", requiresArr: true },
  { value: "arrDownloadDate", label: "Download Date", type: "date", section: "arrMedia", requiresArr: true },

  // ─── Arr: Episodes ──────────────────────────────────────────────────────
  { value: "arrSeasonCount", label: "Season Count", type: "number", section: "arrEpisodes", requiresArr: true },
  { value: "arrEpisodeCount", label: "Episode Count", type: "number", section: "arrEpisodes", requiresArr: true },
  { value: "arrHasUnaired", label: "Has Unaired", type: "boolean", section: "arrEpisodes", knownValues: ["true", "false"], requiresArr: true },
  { value: "arrMonitoredSeasonCount", label: "Monitored Seasons", type: "number", section: "arrEpisodes", requiresArr: true },
  { value: "arrMonitoredEpisodeCount", label: "Monitored Episodes", type: "number", section: "arrEpisodes", requiresArr: true },
